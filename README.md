...
Running the code in WoodBuffaloDataCleaning.R (Up until the plotting section) will import and organize the Oil Sands data into a cleaner form that is optimal for plotting.
